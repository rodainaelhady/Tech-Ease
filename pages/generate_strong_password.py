...
# واجهة المستخدم لتوليد كلمة مرور قوية
class GenerateStrongPassword(ctk.CTkFrame):
    def __init__(self, parent, show_frame):
        super().__init__(parent)
        
        # زر العودة إلى القائمة الرئيسية في أقصى الشمال العلوي مع أيقونة
        ...
        # العنوان في المنتصف مع أيقونة قفل
        ...
        # إطار يحتوي على الإدخال وزر التوليد بجانب بعضهما
        frame = ctk.CTkFrame(self,fg_color="#2B2B2B")
        frame.pack(pady=20, anchor="center")
        
        # حقل إدخال طول كلمة المرور
        ...
        # زر نسخ كلمة المرور إلى الحافظة
    ...
    def generate_and_display_password(self):
        ...
        self.generated_password = password  # حفظ كلمة المرور للنسخ لاحقاً

    # دالة لنسخ كلمة المرور إلى الحافظة
